@extends('layout')
@section('content')
        @foreach ($category_name as $key => $category_pro)
        <title>{{$category_pro->category_name}}</title>
        @endforeach
...
<div class="content">
    <div class="collection">
        @foreach ($category_name as $key => $category_pro)
            <span>{{$category_pro->category_name}}</span>
        @endforeach
                        ...
                        <div class="filter__box__detail filter__brand--detail">
                            ...
                            <ul>
                                <li>
                                    <label>
                                        <a class="dropdown_select" href="{{URL::to('/thuong-hieu/'.$brand_pro->brand_id)}}">
                                            <input type="radio" name="brandm"> {{$brand_pro->brand_name}}
                                        </a>
                                    </label>
                                </li>
                            </ul>
        ...
        <div class="product__item">
            ...
            <div class="product__item__price">
                ...
                <div class="price__button">
                    ...
                    <form action="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}" method="GET">
