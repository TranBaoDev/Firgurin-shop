@extends('layout')
@section('content')
    <title>Tất cả sản phẩm - Figurin</title>
    ...
    <div class="content">
        <div class="collection">
            ...
            <div class="collection__categ collection__categ--mobile li-text">
                ...
                <div class="categ__box">
                    <ul>
                        <a href="{{ URL::current() }}" class="dropdown_select">
                            <li class="categ--check">
                                <i class="fa-solid fa-check"></i>
                                Tất cả sản phẩm
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=price_asc' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Giá: Tăng dần
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=price_desc' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Giá: Giảm dần
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=name_asc' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Tên: A-Z
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=name_desc' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Tên: Z-A
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=oldest' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Cũ nhất
                            </li>
                        </a>
                        <a href="{{ URL::current() . '?sort=newest' }}" class="dropdown_select">
                            <li>
                                <i class="fa-solid fa-check"></i>
                                Mới nhất
                            </li>
            ...
            <div class="filter__option li-text">
                ...
                <div class="filler__box">
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?price=lower_1mil' }}" class="dropdown_select">
                                    <span>
                                        Dưới 1.000.000₫
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?price=between_1mil_to_2mil' }}" class="dropdown_select">
                                    <span>
                                        1.000.000₫ - 2.000.000₫
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?price=between_2mil_to_3mil' }}" class="dropdown_select">
                                    <span>
                                        2.000.000₫ - 3.000.000₫
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?price=between_3mil_to_4mil' }}" class="dropdown_select">
                                    <span>
                                        3.000.000₫ - 4.000.000₫
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?price=over_4mil' }}" class="dropdown_select">
                                    <span>
                                        Trên 4.000.000₫
                                    </span>
                                </a>
            ...
            <div class="filter__option li-text">
                ...
                <div class="filler__box">
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_12' }}" class="dropdown_select">
                                    <span>
                                        1/12
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_10' }}" class="dropdown_select">
                                    <span>
                                        1/10
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_7' }}" class="dropdown_select">
                                    <span>
                                        1/7
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_6' }}" class="dropdown_select">
                                    <span>
                                        1/6
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_5' }}" class="dropdown_select">
                                    <span>
                                        1/5
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_4' }}" class="dropdown_select">
                                    <span>
                                        1/4
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=1_3' }}" class="dropdown_select">
                                    <span>
                                        1/3
                                    </span>
                                </a>
                    ...
                    <ul>
                        <li>
                            <label>
                                <a href="{{ URL::current() . '?scale=non_scale' }}" class="dropdown_select">
                                    <span>
                                        Non scale
                                    </span>
                                </a>
                ...
                <div class="product__item">
                    <a href="{{ URL::to('/chi-tiet-san-pham/' . $product->product_id) }}">
                        <img src="{{ URL::to('uploads/product/' . $product->product_image) }}"
                            title="{{ $product->product_name }}" alt="">
                    </a>
        ...
        <nav style="width: 80%;" aria-label="Page navigation">
            {!! $data->links('name') !!}
        </nav>
    </div>
@endsection
