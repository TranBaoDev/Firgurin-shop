                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                 ...
                                 {{-- <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" class="form-control" name="brand_product_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$edit_value->meta_keywords}}</textarea>
                                </div> --}}
