...
class ProductController extends Controller
{
    ...
    public function save_product(Request $request){
        ...
        $data['product_series'] = $request->product_series;
        $data['product_size'] = $request->product_size;
        $data['product_proportion'] = $request->product_size;
        $data['product_date'] = $request->product_date;
        $data['product_price'] = $request->product_price;
        $data['product_price_update'] = $request->product_price_update;
        $data['category_id'] = $request->product_cate;
        $data['brand_id'] = $request->product_brand;
        $data['product_status'] = $request->product_status;
        $data['product_image'] = $request->product_status;
        $data['product_image2'] = $request->product_status;
        $data['product_image3'] = $request->product_status;
        $data['product_image4'] = $request->product_status;
        ...
        if($get_image){
            ...
            $data['product_image3'] = $new_image;
            $data['product_image4'] = $new_image;
    ...
    public function update_product(Request $request, $product_id){
        ...
        $data['product_series'] = $request->product_series;
        $data['product_size'] = $request->product_size;
        $data['product_proportion'] = $request->product_proportion;
        $data['product_date'] = $request->product_date;
        $data['product_price'] = $request->product_price;
        $data['product_price_update'] = $request->product_price_update;
        $data['category_id'] = $request->product_cate;
    ...
    public function details_product($product_id)
    {
        ...
        $related_product = DB::table('tbl_product')->join('tbl_category_product','tbl_category_product.category_id', '=', 'tbl_product.category_id')
                                                    ->join('tbl_brand_product','tbl_brand_product.brand_id', '=', 'tbl_product.brand_id')
                                                    ->where('tbl_category_product.category_id', $category_id)->whereNotIn('tbl_product.product_id',[$product_id])->limit(5)->get();
        return view('pages.show.show_detail_product')->with('category', $cate_product)
